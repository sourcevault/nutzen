...
(function(){
  var reg, com, main, z, chalk, l, prettyError, R, modflag, print, packageJ, x$, c, help, pe, name, arrange, show_stack, show_chain, map_fname_to_ctypes, StrArgLen, lit, StrEType, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
