...
(function(){
  ...
  StrArgLen = function(fname, ctype, eType){
    ...
    switch (eType) {
    case 'many_args':
      return ["too many arguments", lit(["  only " + data[0] + " arguments \n\n  accepted type :: " + data[1] + " "], [c.pink])];
    case 'few_args':
      return ["too few arguments", lit(["  requires " + data[0] + " arguments \n\n  type : " + data[1] + " "], [c.pink])];
    }
  };
  ...
  print.typeError = function(data){
    var ref$, fname, attribute, type_signature, comment;
    ref$ = data, fname = ref$[0], attribute = ref$[1], data = ref$[2];
  ...
  print.unary_not_array = function(data){
  ...
  print.arpar_not_array = function(data){
    var type_signature;
