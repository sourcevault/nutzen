...
(function(){
  var reg, com, main, z, l, R, c, esp, modflag, print, packageJ, help, lit, name, arrange, show_stack, show_chain, map_fname_to_ctypes, StrArgLen, StrEType, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
