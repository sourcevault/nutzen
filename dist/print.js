...
(function(){
  var reg, com, main, z, l, prettyError, R, c, esp, modflag, print, packageJ, help, lit, name, arrange, show_stack, show_chain, map_fname_to_ctypes, StrArgLen, StrEType, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  reg = require("./registry");
  com = reg.com, main = reg.main;
  z = com.z, l = com.l, prettyError = com.prettyError, R = com.R, c = com.c, esp = com.esp;
  modflag = reg.modflag;
  print = reg.print;
