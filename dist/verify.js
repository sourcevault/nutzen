...
(function(){
  var reg, com, verify, print, sig, already_created, z, R, V, betterTypeof, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
