var reg, com, main, modflag, print, z, l, R, c, esp, create_stack, lit, packageJ, help, show_stack, pkgname, arrange, show_chain, map_fname_to_ctypes, StrArgLen, StrEType, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
reg = require("./registry");
com = reg.com, main = reg.main, modflag = reg.modflag, print = reg.print;
